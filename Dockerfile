...
RUN apt-get update && apt-get install -y openbox tigervnc-standalone-server novnc websockify xterm wget curl ca-certificates midori dbus-x11 openssl && rm -rf /var/lib/apt/lists/*
